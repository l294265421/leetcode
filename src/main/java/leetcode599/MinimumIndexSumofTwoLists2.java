...
public class MinimumIndexSumofTwoLists2 {
    public String[] findRestaurant(String[] list1, String[] list2) {
    	...
    	minIndexSums.add(Integer.MAX_VALUE);
    	LinkedList<String> minIndexCommonInterest = new LinkedList<>();
    	minIndexCommonInterest.add(null);
    	for(int i = 0; i < list1.length; i++) {
    		for(int j = 0; j < list2.length; j++) {
    			if (i + j > minIndexSums.getFirst()) {
					break;
				}
    ...
    public static void main(String[] args) {
		...
		MinimumIndexSumofTwoLists2 minimumIndexSumofTwoLists = new MinimumIndexSumofTwoLists2();
